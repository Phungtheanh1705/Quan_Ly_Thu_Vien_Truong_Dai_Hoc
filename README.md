...
## 📖 1. Giới thiệu
Hệ thống Quản lý Thư viện Trường Đại học được xây dựng nhằm hỗ trợ công tác quản lý, lưu trữ và tra cứu thông tin sách, tạp chí, tài liệu học tập, cũng như quản lý mượn/trả sách của sinh viên và cán bộ.  
Thay vì quản lý thủ công bằng giấy tờ hay các file Excel rời rạc, hệ thống mang đến một giải pháp tập trung, hiện đại và dễ sử dụng, giúp thư viện vận hành hiệu quả, tiết kiệm thời gian và nâng cao trải nghiệm người dùng.
